<footer class="footer">
  ...
  <section class="mas-info">
    ...
    <ul>
      ...
      <li><a href="#"><i class="fas fa-gift"></i><br>Giftcards</a></li>
      </div>
  <div class="info">

    <li><a href="#"><i class="far fa-question-circle"></i><br>Ayuda</a></li>
    </div>
  </div>
  <div class="infocard">
  <div class="info">

    <li><a href="#"><i class="fas fa-phone"></i><br>Contacto</a>
    </li>
